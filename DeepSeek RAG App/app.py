...
header_image = "https://images.app.goo.gl/1HKkvhMM2cLsogCN7?text=DeepSeek+RAG"

with gr.Blocks(css=custom_css, title="DeepSeek RAG") as demo:
    with gr.Row():
        gr.Markdown("<div class='title'>DeepSeek RAG</div>")
    with gr.Row():
